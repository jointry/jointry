...
import jointry.ast.ASTLeaf;
import jointry.ast.ASTList;
...
public class Parser {
	...
	protected static abstract class AToken extends Element {
		...
		{
			Token t = lexer.read();
			if(!test(t)) throw new ParseException(t);
	...
	protected static abstract class Factory {
		...
		@SuppressWarnings("unchecked") // CA,20120313
									 ...
									 Class<?> argType)
		{
			...
			try {
				final Method m =
					clazz.getMethod(factoryName, new Class<?>[] { argType });
				return new Factory() {
						protected ASTree make0(Object arg) throws Exception {
	...
	public ASTree parse(Lexer lexer) throws ParseException {
		...
		for(Element e: elements) e.parse(lexer, results);
