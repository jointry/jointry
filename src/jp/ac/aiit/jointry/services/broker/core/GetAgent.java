...
public class GetAgent extends HttpBase {
	public GetAgent(Monitor monitor) { setMonitor(monitor); }
	...
	/**
	 * 指定された URL から HTTP GET でテキストデータを取得する。
	 * レスポンスのヘッダ部とボディ部をモニタに表示することができる。
	 * @param u URL情報
	...
	/**
	 * ソケットのリーダからメッセージを１行受信する。
	 * 相手のソケットがクローズされるか、タイムアウトの場合 null を返す。
	 */
