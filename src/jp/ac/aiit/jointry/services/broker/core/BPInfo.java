 ...
 * メッセージの文字列表現と内部のデータ構造の間の相互変換のためのメソッドを 提供する。 プロトコルは全て文字列で送受信される。
 ...
 * </pre>
 * <p>
 * 改行コードによって分けられた文字列が通信の処理単位であるメッセージである。 メッセージは空白文字で分けられた複数のトークンの列から構成される。
 * 先頭のトークンはメッセージの種別を示すダイアログ識別名である。 ダイアログ識別名に続くトークンはダイアログのプロパティとして扱われる。
 * <p>
 * 各プロパティはキーと値を持つ。キーと値は分離文字'='で分けられる。 キーはプロパティの種別を表し値はその内容である。
 * 値は空白文字以外の任意の文字からなる文字列であり空文字列であっても良い。 空文字列の場合は分離文字は省略できる。
 * <p>
 * プロパティの値は任意の文字列を持ち得る。メッセージの中のプロパティには 空白文字や改行コードを含めることができないので、プロパティの値はエスケープ
 * 処理を施し、空白文字と改行コードを含まない文字列に変換されてメッセージが 組み立てられる。
 * <p>
 * BPInfoは、プロトコルの各プロパティに対して、キーを指定して、値の設定、 値の読取り、値の判定などを行う各種のメソッドを提供している。
 */
public class BPInfo implements Common {
     ...
     * @return プロパティの定義情報の文字列
     */
    public String params(String vs, String ps) {
        return params(vs, ps, false);
    }
    ...
    /**
     * 指定されたキーと整数値を持つプロパティを設定する。 設定済みの場合は再設定する（値を置換する）。
     *
     * @param key プロパティのキー
    ...
    /**
     * 指定されたキーと値を持つプロパティを設定する。 設定済みの場合は再設定する（値を置換する）。
     *
     * @param key プロパティのキー
     * @param value プロパティの値
     */
    ...
    /**
     * 指定されたキーが存在しかつ値を持たないならば指定された値を設定する。 参照できるが設定を許さないプロパティのアクセス制御の際に利用する。
     *
     * @param key プロパティのキー
     * @param value プロパティの値
    ...
    /**
     * 指定されたキーの値を整数値として取得する。値が未定義(null)の場合は デフォルト値を返す。
     *
     * @param key プロパティのキー
     * @param defaultVal プロパティのデフォルト値
     * @return キーの値の整数値
    ...
    /**
     * 指定された文字列配列を":"を分離文字として連結した文字列を、 指定されたキーの値に設定する。
     *
     * @param key プロパティのキー
    ...
    /**
     * 指定されたキーの値（":"を分離文字とする文字列）を文字列配列として 取得する。
     *
     * @param key プロパティのキー
     * @return 文字列配列
     */
    ...
    /**
     * 指定された文字列配列を指定された分離文字で連結した文字列を、 指定されたキーの値に設定する。
     *
     * @param key プロパティのキー
     * @param values プロパティの文字列配列
    ...
    /**
     * 指定されたキーの値（指定された分離文字列で連結した文字列）を 文字列配列として取得する。
     *
     * @param key プロパティのキー
     * @param separator 文字列の分離文字
     * @return 文字列配列
    ...
    /**
     * 指定された整数値配列を":"で連結した文字列を、指定されたキーの値に 設定する。
     *
     * @param key プロパティのキー
     * @param values プロパティの文字列配列
     */
    ...
    /**
     * 指定されたキーの値（数字を":"で連結した文字列）を、整数値配列として 取得する。
     *
     * @param key プロパティのキー
     * @return キーの値の整数値配列
     */
    public int[] getIntArray(String key) {
        ...
        for (String item : items) {
            array[i++] = Util.getInt(item);
        }
        return array;
    }

    /**
     * 指定された画像ファイルをBase64エンコードした文字列を、 指定されたキーの値に設定する。
     *
     * @param key プロパティのキー
     * @param fname ファイル名
     */
    public void setImage(String key, String fname) {
        set(key, Base64.encode(fname));
    }

    /**
     * 指定されたキーのBase64エンコードされた文字列を、画像データとして取得する。
     *
     * @param key プロパティのキー
     * @return キーの値の画像データ
     */
    public BufferedImage getImage(String key) {
        ...
        return ImageUtil.createImage(list);
    }
    ...
    /**
     * 指定されたキーの値に指定された文字列を要素として追加する。 この際、指定された分離文字を使用する。
     *
     * @param key プロパティのキー
     * @param value 追加する文字列
     * @param separator 文字列の分離文字
     ...
     * 特殊文字のエスケープ処理：
     * <p>
     * スペース、タブ、改行を含む文字列を、これらを含まない文字列に変換する。 スペースは `~' で表す。
     ...
     * 特殊文字のアンチエスケープ処理：
     * <p>
     * escape(value)でエスケープ処理した文字列を元の文字列に復元する。
     * <pre>
     * 例: Takashi~Yamada\t45\\5 --> Takashi Yamada	45\5
     * </pre>
     */
